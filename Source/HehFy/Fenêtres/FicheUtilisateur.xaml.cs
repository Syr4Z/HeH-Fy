    ...
    public partial class FicheUtilisateur : Window
    {
        ...
        private void BTN_Valider_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (VerifierFormulaire())
            {
                if(NomUtilisateur == "")
                {
                    Utilisateur.Rechercher(TB_Nom.Text.ToLower(), out existe);
                    if (!existe)
                    {
                ...
                } else
                {
                    ...
                    {
                        if (TB_MotDePasse.Password != this.Utilisateur.MotDePasse)
                        {
                            this.Utilisateur.MotDePasse = TB_MotDePasse.Password;
                        }
                        else
                        {
                            message = "Le mot de passe est identique à l'ancien et n'as pas été modifié";
                            MessageBox.Show("Mot de passe non modifié !", message, MessageBoxButton.OK, MessageBoxImage.Information);
                        }
                    }
                }
